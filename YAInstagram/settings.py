"""
Django settings for YAInstagram project.
...
WSGI_APPLICATION = 'YAInstagram.wsgi.application'
...
# whitenoise hides static file as regular files so heroku can accept them 
